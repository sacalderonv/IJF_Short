...
```
**Remark:** The R version used to run the simulations was 4.3.3, however you can use the most recent R version. Additionally, you can also use the most recent version of the package `mtarm`(0.1.6).
